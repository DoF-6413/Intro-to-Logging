...
private final FlywheelSim MotorSim;
  ...
  public MotorIOSim() {
    MotorSim = new FlywheelSim(DCMotor.getNEO(1), MotorConstants.GEAR_RATIO, MotorConstants.MOMENT_OF_INERTIA);
  ...
  public void updateInputs(MotorIOInputs inputs) {
    ...
    inputs.PositionDegrees = Units.radiansToDegrees(MotorSim.getAngularVelocityRadPerSec() * RobotStateConstants.LOOP_PERIODIC_SEC);
    inputs.PositionRadians = MotorSim.getAngularVelocityRadPerSec() * RobotStateConstants.LOOP_PERIODIC_SEC;
  }
